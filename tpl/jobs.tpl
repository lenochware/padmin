...
string first_run_at lb "První spuštění" sort date "%d.%m.%Y %H:%M"
string last_run_at lb "Poslední spuštění" sort date "%d.%m.%Y %H:%M"
string last_run_result lb "Výsledek" format "h" size "50" tooltip
string created_at lb "Vytvořeno" sort date "%d.%m.%Y %H:%M" skip
